...
[`Download Python source code: two_layer_net_module.py`](../../_downloads/two_layer_net_module.py)[`Download Jupyter notebook: two_layer_net_module.ipynb`](../../_downloads/two_layer_net_module.ipynb)
