...
| Conv{1,2,3}D | 1 |
| Sigmoid | 1 |
| Tanh | ![](http://latex.codecogs.com/gif.latex?\\frac{5}{3}) |
| ReLU | ![](http://latex.codecogs.com/gif.latex?\\sqrt{2})  |
| Leaky Relu | ![](http://latex.codecogs.com/gif.latex?\sqrt{\frac{2}{1+negativeslope^2}}) |
