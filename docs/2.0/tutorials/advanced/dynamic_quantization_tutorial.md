...
## 1. 定义模型 [¶](#define-the-model "永久链接到此标题")
...
## 2. 加载文本数据 [¶](#load-in-the-text-data "固定链接到此标题")
...
## 3. 加载预训练模型 [¶](#load-the-pretrained-model "永久链接到此标题")
...
## 4. 测试动态量化 [¶](#test-dynamic-quantization "固定链接到此标题")
