...
所有的深度学习都是在张量上计算的,其中张量是一个可以被超过二维索引矩阵的一般化.
...
# 利用给定数据创建一个torch.Tensor项目.这是一个一维向量
V_data = [1., 2., 3.]
...
#
# 当然它掩盖了如何计算导数的挑战.这里的观点是s携带了足够多的信息所以导数可以被计算.现实中,Pytorch
