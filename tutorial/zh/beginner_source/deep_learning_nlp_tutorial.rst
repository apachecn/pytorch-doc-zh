...
.. galleryitem:: /beginner/nlp/deep_learning_tutorial.py
    :intro: 深度学习以巧妙的方式将non-linearities和linearities组合在一起.non-linearities的引入允许

.. galleryitem:: /beginner/nlp/word_embeddings_tutorial.py
    :intro: 单词嵌入是真实数字的密集向量,在你的词汇表中每一个单词都是. 在NLP中, 通常情况下, 您的特性就是
...
.. galleryitem:: /beginner/nlp/advanced_tutorial.py
    :intro: 动态 VS 静态深度学习工具集.Pytorch 是一个 动态 神经网络工具包. 
